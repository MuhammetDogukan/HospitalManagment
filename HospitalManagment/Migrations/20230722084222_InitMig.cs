    ...
    public partial class InitMig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FamilyDoctorsId = table.Column<int>(type: "int", nullable: false),
                    MyPatientsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorPatients", x => new { x.FamilyDoctorsId, x.MyPatientsId });
                    table.ForeignKey(
                        name: "FK_DoctorPatients_Doctors_FamilyDoctorsId",
                        column: x => x.FamilyDoctorsId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorPatients_Patients_MyPatientsId",
                        column: x => x.MyPatientsId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentMedication_Medication_MedicationsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorPatients_MyPatientsId",
